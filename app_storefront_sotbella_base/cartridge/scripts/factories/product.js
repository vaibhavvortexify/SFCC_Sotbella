            ...
            case 'bonusProductLineItem':
                ...
                switch (productType) {
                    case 'bundle':
                        ...
                        break;
                    default:
                        var variationsBundle = productHelper.getVariationModel(
                            apiProduct,
                            params.variables
                        );
                        if (variationsBundle) {
                        ...
                        var lineItemOptionsBundle = optionLineItemsBundle.length
                            ...
                            : productHelper.getDefaultOptions(
                                  optionModelBundle,
                                  optionModelBundle.options
                              );
            ...
            case 'productLineItem':
                ...
                switch (productType) {
                    case 'bundle':
                        ...
                        break;
                    default:
                        var variationsPLI = productHelper.getVariationModel(
                            apiProduct,
                            params.variables
                        );
                        if (variationsPLI) {
