...
var SplitPLIHelper = require('*/cartridge/scripts/helpers/SplitPLIHelper');
var ShipmentDistributionHelper = require('*/cartridge/scripts/helpers/ShipmentDistributionHelper');
...
exports.calculate = function (basket) {
    ...
    // ===================================================
    // ===   SPLIT LINE ITEM & DISTRIBUTE SHIPMENT    ====
    // ===================================================

    // try {
    //     var currentSite = Site.getCurrent();
    //     if (currentSite && currentSite.getID() === 'sotbella_in') {
    //         Logger.info('Skipping Split and Distribute Shipment logic for site: {0}', currentSite.getID());
    //     }else {
    //         SplitPLIHelper.splitProductLineItems(basket);  
    //         ShipmentDistributionHelper.organizeShipments(basket);
    //     }
    // } catch (e) {
    //     Logger.error('Error in Split and Distribute Shipment logic: {0}\nStack: {1}', e.message, e.stack);
    // }
